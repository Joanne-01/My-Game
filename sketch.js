...
function preload() {
  ...
  cloudImg = loadAnimation("/clouds/cloud1", "/clouds/cloud2", "/clouds/cloud3");
...
function setup() {
  ...
  Moon = createSprite(100,200,10,10)
...
function spawnClouds() {
  Cloud = createSprite(width, random(height / 3, height / 2))
...
function spawnvillians(a) {
  Villian = createSprite(width, height-100, 10, 10);
  var choice=a
  switch(choice){
